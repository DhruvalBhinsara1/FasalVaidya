...
- From `E:/FasalVaidya/backend`:
  - `$env:MODEL_PATH="E:/FasalVaidya/backend/ml/models/plantvillage-npk-v2.h5"`
...
## Notes
- MODEL_PATH must point to the latest `plantvillage-npk-v2.h5`; restart the backend after replacing the model file.
